          ...
          Container(
            ...
            child: GridView.count(
              ...
              children: [
                ...
                itemDashboard(context, 'Diet Plans', CupertinoIcons.heart_circle_fill, Colors.purple,MentalHealthArticlesPage()),
                ...
                itemDashboard(context, 'Exercise Routines', CupertinoIcons.add_circled, Colors.teal,MentalHealthArticlesPage()),
                itemDashboard(context, 'Yoga Practices', CupertinoIcons.question_circle, Colors.blue,const YogaPage()),
                itemDashboard(context, 'Emergency Contacts', CupertinoIcons.phone, Colors.pinkAccent,MentalHealthArticlesPage()),
              ],
            ),
          )
        ],
