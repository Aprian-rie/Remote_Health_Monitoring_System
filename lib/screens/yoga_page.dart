...
class YogaPage extends StatefulWidget {
  ...
  @override
  State<YogaPage> createState() => _ArticlesState();
}

class _ArticlesState extends State<YogaPage> {
  ...
  Future _retrieveArticles() async {
    Response response = await client.get(Uri.parse(
        'https://newsapi.org/v2/everything?q=yoga%20or%20exercise%20or%20relax%20health&from=${date}&sortBy=publishedAt&apiKey=$API_KEY'));
